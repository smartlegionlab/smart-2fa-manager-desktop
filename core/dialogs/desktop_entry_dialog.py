...
class DesktopEntryDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.app_name = "Smart 2fa Manager"
    ...
    def create_app_menu_entry(self):
        try:
            ...
            desktop_file = os.path.join(desktop_dir, "smart-2fa-manager.desktop")
...
Type=Application
Name={self.app_name}
Comment=Offline, independent TOTP 2FA manager for Linux with graphical interface.
Exec={exec_line}
Icon={self.icon_path if self.icon_path else 'system-run'}
Terminal=false
Categories=Utility;Security;
StartupNotify=true
Keywords=manager;security;encryption;two-factor;
"""
        return content
